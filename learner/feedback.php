...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // 1. Trace the tutor reference tied to this booking using correct PK 'id'
        ...
        if ($tutor_id) {
            // 2. Insert into the ratings table (matches layout from image_a32894.png)
            ...
            // 3. Insert into the feedback comments table (matches layout from image_a32b9a.png)
            ...
            // 4. Update booking record flag to audited status using core pk mapping 'id'
            ...
            echo "<div style='font-family:\"Segoe UI\", Arial, sans-serif; text-align:center; padding: 60px 20px; background:#f8fafc; min-height:100vh; box-sizing:border-box;'>";
            ...
            echo "<div style='font-size: 48px; margin-bottom: 15px; color: #f59e0b;'>★</div>";
        ...
        die("An unexpected execution exception occurred. Details: " . htmlspecialchars($e->getMessage()));
    }
} else {
